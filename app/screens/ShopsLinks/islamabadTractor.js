...
export default class islamabadTractor extends Component {
    render(){
  return (
      <ScrollView>
    <ImageBackground
...
<Text style={{ fontSize: 20, fontFamily: "serif", fontWeight: "bold" ,marginLeft:20,marginTop:10}}>Links For Tractors</Text>
<View style={{flexDirection:"row" , marginLeft:25,marginTop:10}}>
        ...
        <Icon name="ios-contact" size={35} color="#fff" />
            ...
            <Text style={styles.nameSettings}>Faisal Fertilizer</Text>
