...
export default class lahoreShop extends Component {
    render(){
  return (
      <ScrollView>
    <ImageBackground
    ...
    >
        ...
        <Text style={{ fontSize: 20, fontFamily: "serif", fontWeight: "bold" ,marginLeft:20,marginTop:10}}>Info of Fertilizer Dealers</Text>
