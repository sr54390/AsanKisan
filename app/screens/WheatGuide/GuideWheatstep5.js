...
export default class GuideWheatstep5 extends React.Component {
  constructor() {
    super();
    this.state = {
      todos: {},
  ...
  componentDidMount() {
    db.ref('/WheatGuideStep5').on('value', querySnapShot => {
  ...
  addNewTodo() {
    db.ref('/WheatGuideStep5').push({
      done: false,
      todoItem: this.state.presentToDo5,
    });
    ...
    return (
      <ScrollView
        ...
        contentContainerStyle={styles.contentContainerStyle}>
          ...
          />
          <Text style={{ fontWeight: "bold" }}>45% Completed</Text>
          <Weather4Guides />
       
        <View style={styles.containerOK}>
                 <Text style={styles.mainHeadings}>Wheat Guide  </Text>
                 <Text style={styles.mainHeadings}>Step 5  </Text>
                 <Text style={styles.mainHeadings}>Second water </Text>
</View>
        {/* <TextInput
 ...
 <View>
       ...
       <TouchableOpacity style={styles.Stepbtn} >
        <Text style={{color:"#FFF",fontWeight:"500"}} onPress={()=> {this.props.navigation.navigate("wheatstep6")}}> Go to Step 6</Text>
      </TouchableOpacity>
