...
export default class GuideWheatstep6 extends React.Component {
  ...
  componentDidMount() {
    db.ref('/WheatGuideStep6').on('value', querySnapShot => {
  ...
  addNewTodo() {
    db.ref('/WheatGuideStep6').push({
      done: false,
      todoItem: this.state.presentToDo6,
    });
