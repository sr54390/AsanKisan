...
export default class GuideWheatstep7 extends React.Component {
  constructor() {
    super();
    this.state = {
      todos: {},
  ...
  componentDidMount() {
    db.ref('/WheatGuideStep7').on('value', querySnapShot => {
  ...
  addNewTodo() {
    db.ref('/WheatGuideStep7').push({
      done: false,
      todoItem: this.state.presentToDo7,
    });
    ...
    return (
      <ScrollView
        ...
        contentContainerStyle={styles.contentContainerStyle}>
          ...
          />
          <Text style={{ fontWeight: "bold" }}>75% Completed</Text>
          <Weather4Guides />
